    ...
    <div id="projects" className="carousel slide" data-ride="carousel">
      <div className="carousel-inner">
        ...
        <div className="carousel-item">
          ...
          <div className="overlay">
            <p className="overlay-text">
              <a href="https://mbta-app.vercel.app/" target="_blank"><h2>MBTA Arrival Predictions (In Development)</h2></a><br/>
        ...
        <div className="carousel-item">
          ...
          <div className="overlay">
            <p className="overlay-text">
              <a href="http://hatsunem.icu" target="_blank"><h2>hatsunem.icu</h2></a><br/>
