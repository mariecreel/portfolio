    ...
    <div id="projects" className="carousel slide" data-ride="carousel">
      <div className="carousel-inner">
        ...
        <div className="carousel-item active">
          ...
          <div className="overlay">
            <p className="overlay-text">
              <a href="https://cursed.co.in/movie-db-react" target="_blank"><h2>Movie Search</h2></a>
              <a href="https://github.com/ncreel/movie-db-react/">Github Repo</a><br/>
              Searches for movies through calls to <a href="https://developers.themoviedb.org/3/getting-started/introduction">The Movie Database's API (TMDb API)</a>.<br/><br/>
        ...
        <div className="carousel-item">
          ...
          <div className="overlay">
            <p className="overlay-text">
              <a href="https://mbta-app.vercel.app/" target="_blank"><h2>MBTA Arrival Predictions (In Development)</h2></a>
              <a href="https://github.com/ncreel/mbta-app">Github Repo</a><br/>
        ...
        <div className="carousel-item">
          ...
          <div className="overlay">
            <p className="overlay-text">
              <a href="http://hatsunem.icu" target="_blank"><h2>hatsunem.icu</h2></a>
              <a href="https://github.com/ncreel/hatsunem.icu">Github Repo</a><br/>
              Loads a random youtube video from a curated playlist of
              songs featuring Vocaloid Hatsune Miku through calls to the <a href="https://developers.google.com/youtube/v3">YouTube API</a>.<br/><br/>
